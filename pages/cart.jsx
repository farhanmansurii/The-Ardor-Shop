  ...
  return (
    <div className="w-11/12 mx-auto">
      ...
      {products.length > 0 ? (
        products.map((e) => (
          ...
          >
            ...
            <div className="flex  w-fit gap-3 ">
              <div className="text-xl text-primary font-bold my-auto">
                ₹{e.price * 6}
              </div>
        ...
        <div className="font-ibm  font-bold text-2xl mx-auto  py-2 align-center ">
          No items in cart
        </div>
      )}
      {products.length > 0 && (
        <>
          <div className="font-ibm font-bold text-2xl     mt-6 mb-3 flex ">
            {" "}
            Subtotal : ₹
            {products.reduce(
              (sum, i) => (sum += i.cartQuantity * i.price * 6),
              0
            )}
            .00
          </div>
