  ...
  return (
    <div className="flex flex-col lg:flex-row w-[96%] mx-auto  mt-2 font-ibm">
      ...
      <div className="mx-auto  gap-4 h-11/12 my-auto py-4">
        <div className="text-xl lg:text-3xl w-10/12 mx-auto ">
          {deets.title}
        </div>
        <div>
          <div className="flex gap-2 w-10/12 mx-auto my-3 ">
            <div className="border-2 border-primary w-fit px-3  hover:scale-105 duration-200 py-1">
              S
            </div>
            <div className="border-2 border-primary w-fit px-3 hover:scale-105 duration-200 py-1">
              M
          ...
          <div className="my-5 flex  w-10/12  font-bold font-xl    mx-auto">
            <div className=" btn rounded-none bg-base-100 border-primary text-primary hover:text-base-100 hover:bg-primary ">
              {" "}
              ₹{deets.price * 6}
            </div>
            <button
