      ...
      <div className="mx-auto  gap-4 h-11/12 my-auto py-4">
        ...
        <div>
          ...
          <div className="flex gap-2  mx-auto my-3 text-secondary  ">
            <div className="border-2 border-secondary  w-fit px-3  hover:scale-105 duration-200 uppercase py-1">{deets.size}</div>
          </div>
          <div className="my-5 flex  gap-4 font-bold font-xl    mx-auto">
            <div className="   text-secondary hover:bg-primary   uppercase  w-fit py-2  px-3 rounded-none    border-primary ease-in-out font-normal duration-100">₹{deets.price}</div>
            {isButtonLoading ? (
